...
import NewPurchaseEntry from '../components/NewPurchaseEntry';
import withAuth from '../common/auth';
import SupplierPaymet from '../components/SupplierPayament';
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex flex-grow overflow-hidden p-6 space-x-6">
          <SupplierPaymet className="flex-grow h-full overflow-auto" />
        </div>
      </div>
    </div>
  );
...
export default withAuth(PaymentSupplier);
